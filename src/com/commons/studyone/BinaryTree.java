...
public class BinaryTree {
	...
	public void test () {
		...
		TNode t1 = add(getRoot(), "B", true);
		TNode t2 = add(getRoot(), "D", false);

		TNode t3 = add(t1, "G", true);
		TNode t4 = add(t1, "H", false);

		TNode t5 = add(t2, "C", true);
		TNode t6 = add(t2, "F", false);

		System.out.println("-----" + treeLevel(getRoot(), 3));
